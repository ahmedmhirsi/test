...
class Sprint
{
    ...
    #[Assert\Positive(message: "L'objectif de vélocité doit être positif")]
    ...
    #[Assert\Choice(choices: ['planifie', 'actif', 'termine'], message: "Le statut doit être valide (planifie, actif, termine)")]
